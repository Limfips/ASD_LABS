...
//    for(long int *ptr = first; ptr <= &first[n - 1]; ptr++)
//    {
...
//    sixth = reinterpret_cast<int **>(fifth);
//    std::cout << sixth[1][1] << std::endl;
//
